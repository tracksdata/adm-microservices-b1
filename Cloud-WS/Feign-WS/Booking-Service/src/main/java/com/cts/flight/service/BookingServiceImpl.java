...
public class BookingServiceImpl implements BookingService {
	...
	@Autowired
	private SearchServiceProxy ssp;
	@Autowired
	private FareServiceProxy fsp;
	...
	public BookingRecord bookFlight(String flightNumber, String origin, String destination, LocalDate flightDate,
		...
		Flight flight =ssp.findFlight(flightNumber, flightDate, origin, destination);
				//restTemplate.getForObject(
				//searchUrl +  "/findFlight/" +flightNumber+"/" +flightDate+"/"+origin+"/"+ destination,
				//Flight.class);
		Fare fare = fsp.getFare(flightNumber, origin, destination);
				//restTemplate.getForObject(
